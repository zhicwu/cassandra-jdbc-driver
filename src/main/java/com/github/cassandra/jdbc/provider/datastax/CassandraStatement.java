...
public class CassandraStatement extends BaseCassandraPreparedStatement {
    ...
    protected void replaceCurrentResultSet(ParsedSqlStatement parsedStmt, ResultSet resultSet) {
    ...
    public boolean execute(String sql) throws SQLException {
        ...
        ResultSet rs = executeCql(parsedStmt.getSql());
    ...
    public java.sql.ResultSet executeQuery(String sql) throws SQLException {
        ...
        ParsedSqlStatement parsedStmt = ParsedSqlStatement.parse(sql);
        ResultSet resultSet = executeCql(parsedStmt.getSql());
        replaceCurrentResultSet(parsedStmt, resultSet);
