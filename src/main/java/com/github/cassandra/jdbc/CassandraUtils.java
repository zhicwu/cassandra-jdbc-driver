...
import com.github.cassandra.jdbc.parser.RemoveTableAliasVisitor;
...
public class CassandraUtils {
	...
	public static final int DEFAULT_DRIVER_MINOR_VERSION = 1;
			...
			try {
				...
				if (s instanceof Select) {
					...
					select.getSelectBody()
							.accept(new RemoveTableAliasVisitor());
					sql = select.toString();
				} else {
					sql = s.toString();
				}
